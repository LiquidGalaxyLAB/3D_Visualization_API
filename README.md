...
![](connect.png "Connect screen"){:width="48px"}
...
![](launch.png "Connect screen"){:width="48px"}
...
![](launch_info.png "Connect screen"){:width="48px"}
...
### In the android app
![](controls.png "Connect screen"){:width="48px"}
