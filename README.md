...
![](connect.png "Connect screen" | width=5)
...
![](launch.png "Launch screen" | width=5)
...
![](launch_info.png "Launch Info screen" | width=5)
...
### In the android app
![](controls.png "Controls in Android app" | width=5)
